...
namespace git01
{
    public partial class Form_Report_LichDay : Form
    {
        public Form_Report_LichDay()
        {
            InitializeComponent();
        }

        public void ShowReport_LichDay()
        {
            /*ReportDocument report = new ReportDocument();
            report.Load(@"C:\Users\Windows\OneDrive\Desktop\C_Sharp\BTL_01\git01\git01\Report_LichDay.rpt");
            crystalReportViewer1.ReportSource = report;
            crystalReportViewer1.Refresh();*/
            CrystalDecisions.CrystalReports.Engine.ReportDocument
                rpt = new CrystalDecisions.CrystalReports.Engine.ReportDocument();
            rpt.Load(@"C:\Users\Windows\OneDrive\Desktop\C_Sharp\BTL_01\git01\git01\Report_LichDay.rpt");
            ...
            rpt.RecordSelectionFormula = FormLichDay.dieukienReport;
